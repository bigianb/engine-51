...
namespace ui
{
    ...
    static ControlTemplate controls[] =
        {
            {MainMenuDialog::IDC_MAIN_MENU_CAMPAIGN, "IDS_MAIN_MENU_CAMPAIGN", "button", 60, 60, 120, 40, 0, 0, 1, 1, Window::WF_VISIBLE | Window::WF_SCALE_XPOS | Window::WF_SCALE_XSIZE},
            {MainMenuDialog::IDC_MAIN_MENU_MULTI, "IDS_MAIN_MENU_MULTI", "button", 60, 100, 120, 40, 0, 1, 1, 1, Window::WF_VISIBLE | Window::WF_SCALE_XPOS | Window::WF_SCALE_XSIZE},
            {MainMenuDialog::IDC_MAIN_MENU_ONLINE, "IDS_MAIN_MENU_ONLINE", "button", 60, 140, 120, 40, 0, 2, 1, 1, Window::WF_VISIBLE | Window::WF_SCALE_XPOS | Window::WF_SCALE_XSIZE},
            {MainMenuDialog::IDC_MAIN_MENU_SETTINGS, "IDS_MAIN_MENU_SETTINGS", "button", 60, 180, 120, 40, 0, 3, 1, 1, Window::WF_VISIBLE | Window::WF_SCALE_XPOS | Window::WF_SCALE_XSIZE},
            {MainMenuDialog::IDC_MAIN_MENU_PROFILES, "IDS_MAIN_MENU_PROFILES", "button", 60, 220, 120, 40, 0, 4, 1, 1, Window::WF_VISIBLE | Window::WF_SCALE_XPOS | Window::WF_SCALE_XSIZE},
            {MainMenuDialog::IDC_MAIN_MENU_CREDITS, "IDS_EXTRAS_ITEM_CREDITS", "button", 60, 260, 120, 40, 0, 5, 1, 1, Window::WF_VISIBLE | Window::WF_SCALE_XPOS | Window::WF_SCALE_XSIZE},
            {MainMenuDialog::IDC_MAIN_MENU_NAV_TEXT, "IDS_NULL", "text", 0, 0, 0, 0, 0, 0, 0, 0, Window::WF_VISIBLE | Window::WF_SCALE_XPOS | Window::WF_SCALE_XSIZE},
    };
