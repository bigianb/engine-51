        ...
        if( GeomRigidBody.iParentBody != -1 )
        {
            ...
            {            
                ...
                for( int j = 0; j < 3; j++ )
                {
                    ...
                    if(     ( GeomDOF.flags & Geom::RigidBody::Dof::FLAG_ACTIVE )
                        &&  ( GeomDOF.flags & Geom::RigidBody::Dof::FLAG_LIMITED ) )
                    {
...
const char* physics_inst::GetRigidBodyName( int iRigidBody ) const
{
    // Lookup geometry
