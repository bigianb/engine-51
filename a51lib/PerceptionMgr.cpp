...
void perception_mgr::Init()
{
    ...
    // IJB g_AudioHardware.SetPitchFactor( m_AudioTimeDialation );
}

void perception_mgr::Kill()
{
}
...
void perception_mgr::Update( float DeltaTime )
{
    switch( m_State )
    {
        case STATE_NORMAL:
        ...
        case STATE_TO_MUTATE:
            ...
            else
            {
                ...
                float Delta;
                float Scale = 1.0f - (m_Timer / m_BeginMutantLength);
...
void perception_mgr::BeginMutate()
{
    NewState( STATE_BEGIN_MUTATE );
}

void perception_mgr::EndMutate()
{
    NewState( STATE_END_MUTATE );
}

void perception_mgr::BeginShellShock( float Severity )
{
    NewState( STATE_BEGIN_SHELLSHOCK );
}

void perception_mgr::EndShellShock()
{
