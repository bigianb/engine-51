...
public:
    ...
    //of conditions it contains and uses the enum cast to a int to identify the action. Changing
    ...
    enum
    {
        MAX_CONDITION_ENUM_BUFFER = 255
    };

    conditional_base(guid ParentGuid);
    virtual ~conditional_base();

    virtual conditional_types GetType() { return INVALID_CONDITIONAL_TYPES; }
    virtual const char*       GetTypeName() { return "Condtion Base"; }
    virtual const char*       GetTypeInfo() { return "Base condition class, null funtionality"; }
    virtual bool              Execute(trigger_object* pParent) = 0;
    virtual void              OnEnumProp(prop_enum& rList);
    virtual bool              OnProperty(prop_query& rPropQuery);
    conditional_flags         GetFlag() { return m_Flag; }
    bool                      GetElse() { return m_ElseFlag; }
...
public:
    ...
    virtual const char*      GetInfo() { return "\0"; }
...
protected:
    ...
    bool                              m_ElseFlag;   // Flag if this condition is an else condition
...
public:
    ...
    virtual conditional_types GetType() { return TYPE_CONDITION_PLAYER_HEALTH; }
    virtual const char*       GetTypeName() { return "Player Health"; }
    virtual const char*       GetTypeInfo() { return "Checks the player health against a value."; }
    virtual bool              Execute(trigger_object* pParent);
    virtual void              OnEnumProp(prop_enum& rList);
    virtual bool              OnProperty(prop_query& rPropQuery);
...
protected:
    int   m_Code;  // Used to determine what type of conditional check to perform
    float m_Value; // Value of Health to check against..
...
public:
    ...
    virtual conditional_types GetType() { return TYPE_CONDITION_OBJECT_HEALTH; }
    virtual const char*       GetTypeName() { return "Object Health"; }
    virtual const char*       GetTypeInfo() { return "Checks the objects health against a value."; }
    virtual bool              Execute(trigger_object* pParent);
    virtual void              OnEnumProp(prop_enum& rList);
    virtual bool              OnProperty(prop_query& rPropQuery);
    virtual const char*       GetInfo();
...
public:
    ...
    virtual conditional_types GetType() { return TYPE_CONDITION_PLAYER_HAS; }
    virtual const char*       GetTypeName() { return "Player Has"; }
    virtual const char*       GetTypeInfo() { return "Checks if the player has an item."; }
    virtual bool              Execute(trigger_object* pParent);
    virtual void              OnEnumProp(prop_enum& rList);
    virtual bool              OnProperty(prop_query& rPropQuery);
    virtual const char*       GetInfo();
...
protected:
    // IJB inventory_item::inv_type m_ItemType; // ID of item to see if player has
    int                      m_Code;     // Used to determine what type of conditional check to perform
...
public:
    ...
    virtual conditional_types GetType() { return TYPE_CONDITION_PLAYER_STRAIN; }
    virtual const char*       GetTypeName() { return "Player Strain"; }
    virtual const char*       GetTypeInfo() { return "Checks if player is or is not a certain strain."; }
    virtual bool              Execute(trigger_object* pParent);
    virtual void              OnEnumProp(prop_enum& rList);
    virtual bool              OnProperty(prop_query& rPropQuery);
    virtual const char*       GetInfo();
...
public:
    ...
    virtual conditional_types GetType() { return TYPE_CONDITION_OBJECT_EXIST; }
    virtual const char*       GetTypeName() { return "Object Exist"; }
    virtual const char*       GetTypeInfo() { return "Checks the existance state of an object."; }
    virtual bool              Execute(trigger_object* pParent);
    virtual void              OnEnumProp(prop_enum& rList);
    virtual bool              OnProperty(prop_query& rPropQuery);
    virtual const char*       GetInfo();
...
public:
    ...
    virtual conditional_types GetType() { return TYPE_CONDITION_CHECK_STATE_VARS; }
    virtual const char*       GetTypeName() { return "Check a Global Variable"; }
    virtual const char*       GetTypeInfo() { return "Checks a global variable state."; }
    virtual bool              Execute(trigger_object* pParent);
    virtual void              OnEnumProp(prop_enum& rList);
    virtual bool              OnProperty(prop_query& rPropQuery);
    virtual const char*       GetInfo();
...
protected:
    ...
    int                      m_VarRaw;       // Raw data of variable is cast into proper type (float, u32, int, bool) at runtime...
...
public:
    ...
    virtual conditional_types GetType() { return TYPE_CONDITION_CHECK_SCRIPT; }
    virtual const char*       GetTypeName() { return "Check a Script"; }
    virtual const char*       GetTypeInfo() { return "Checks the return value of an executed script."; }
    virtual bool              Execute(trigger_object* pParent);
    virtual void              OnEnumProp(prop_enum& rList);
    virtual bool              OnProperty(prop_query& rPropQuery);
    virtual const char*       GetInfo();
...
protected:
    int m_ScriptID; // Script ID to check
    int m_Code;     // Used to determine what type of conditional check to perform
...
public:
    ...
    virtual conditional_types GetType() { return TYPE_CONDITION_CHECK_TRIGGER_STATE; }
    virtual const char*       GetTypeName() { return "Check a Trigger"; }
    virtual const char*       GetTypeInfo() { return "Checks the return value of an executed trigger."; }
    virtual bool              Execute(trigger_object* pParent);
    virtual void              OnEnumProp(prop_enum& rList);
    virtual bool              OnProperty(prop_query& rPropQuery);
    virtual const char*       GetInfo();
...
public:
    ...
    virtual conditional_types GetType() { return TYPE_CONDITION_RANDOM_CHANCE; }
    virtual const char*       GetTypeName() { return "Random Chance"; }
    virtual const char*       GetTypeInfo() { return "Rolls a dice to see if this comes out TRUE."; }
    virtual bool              Execute(trigger_object* pParent);
    virtual void              OnEnumProp(prop_enum& rList);
    virtual bool              OnProperty(prop_query& rPropQuery);
    virtual const char*       GetInfo();
...
protected:
    float m_RandomPercent; // Random Chance of a True event...
    int   m_Code;          // Used to determine what type of conditional check to perform};
...
public:
    ...
    virtual conditional_types GetType() { return TYPE_CONDITION_ONLY_ON_THIS_NPC; }
    virtual const char*       GetTypeName() { return "On This Npc"; }
    virtual const char*       GetTypeInfo() { return "Checks if the triggering object is this NPC."; }
    virtual bool              Execute(trigger_object* pParent);
    virtual void              OnEnumProp(prop_enum& rList);
    virtual bool              OnProperty(prop_query& rPropQuery);
    virtual const char*       GetInfo();
...
public:
    ...
    virtual conditional_types GetType() { return TYPE_CONDITION_ONLY_ON_THIS_ITEM; }
    virtual const char*       GetTypeName() { return "On This Item"; }
    virtual const char*       GetTypeInfo() { return "Checks if the triggering actor has a particular item."; }
    virtual bool              Execute(trigger_object* pParent);
    virtual void              OnEnumProp(prop_enum& rList);
    virtual bool              OnProperty(prop_query& rPropQuery);
    virtual const char*       GetInfo();
...
protected:
    int m_ItemID; // ID of item of intrest
    int m_Code;   // Used to determine what type of conditional check to perform};
...
public:
    ...
    virtual conditional_types GetType() { return TYPE_CONDITION_COUNT_THINGS; }
    virtual const char*       GetTypeName() { return "Count Things"; }
    virtual const char*       GetTypeInfo() { return "Count various things in the world, NPC, or Player."; }
    virtual bool              Execute(trigger_object* pParent);
    virtual void              OnEnumProp(prop_enum& rList);
    virtual bool              OnProperty(prop_query& rPropQuery);
    virtual const char*       GetInfo();
...
protected:
    int m_Value; // The value to test the count against
    int m_Code;  // Used to determine what type of conditional check to perform};
    int m_LogicCode;
...
public:
    ...
    virtual conditional_types GetType() { return TYPE_CONDITION_CHECK_TIMMER; }
    virtual const char*       GetTypeName() { return "Check Timer"; }
    virtual const char*       GetTypeInfo() { return "Checks the current time of a global timer."; }
    virtual bool              Execute(trigger_object* pParent);
    virtual void              OnEnumProp(prop_enum& rList);
    virtual bool              OnProperty(prop_query& rPropQuery);
    virtual const char*       GetInfo();
...
protected:
    std::string m_TimerName;   //Name of Timer to operate upon
    xhandle     m_TimerHandle; //Handle to the timer
    float       m_Value;       //Value to test against
    int         m_Code;        //Action code
...
public:
    ...
    virtual conditional_types GetType() { return TYPE_CONDITION_COUNTER; }
    virtual const char*       GetTypeName() { return "Counter"; }
    virtual const char*       GetTypeInfo() { return "Checks a internal counter of the number of times this condition has been executed."; }
    virtual bool              Execute(trigger_object* pParent);
    virtual void              OnEnumProp(prop_enum& rList);
    virtual bool              OnProperty(prop_query& rPropQuery);
    virtual const char*       GetInfo();
...
protected:
    int m_Value; //Value to test against
    int m_Count; //Execution Count
    int m_Code;  //Action code
...
public:
    ...
    virtual conditional_types GetType() { return TYPE_CONDITION_ON_THIS_BUTTON; }
    virtual const char*       GetTypeName() { return "On This Button"; }
    virtual const char*       GetTypeInfo() { return "Checks if a certain button has been pressed."; }
    virtual bool              Execute(trigger_object* pParent);
    virtual void              OnEnumProp(prop_enum& rList);
    virtual bool              OnProperty(prop_query& rPropQuery);
    virtual const char*       GetInfo();
