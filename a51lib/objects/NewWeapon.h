...
public:
    ...
    virtual void    GetInterpKey        ( int iBone, AnimKey& Key )    { (void)iBone; (void)Key; }
...
//=========================================================================
    ...
    virtual void                EndAltRampUp            ( bool bGoingIntoHold, bool bSwitchingWeapon ){(void) bGoingIntoHold; (void) bSwitchingWeapon; }
    ...
    virtual AnimGroup::handle* GetAnimGroupHandlePtr   ();
...
inline
int new_weapon::GetTotalPrimaryAmmo()
{
...
inline
int new_weapon::GetTotalSecondaryAmmo()
{
...
inline
int new_weapon::GetMaxPrimaryAmmo()
{
...
inline
int new_weapon::GetMaxSecondaryAmmo()
{
...
inline
float new_weapon::GetCenterPixelOffset()
{
...
inline
new_weapon::render_state new_weapon::GetRenderState()
{
