...
static struct projector_obj_desc : public object_desc
{
    ...
    virtual Object* Create(ObjectManager* om, collision_mgr*, ResourceManager* rm) { return new projector_obj(om, rm); }
...
projector_obj::projector_obj(ObjectManager* om, ResourceManager* rm)
    : Object(om)
    , m_bIsDynamic(false)
    , m_bIsShadow(true)
    , m_bIsActive(true)
