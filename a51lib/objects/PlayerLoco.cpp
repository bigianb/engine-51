...
{
    // Data
    float m_WalkRunMinSpeed;
    float m_WalkRunMaxSpeed;
    float m_WalkRunMinRate;
    float m_WalkRunMaxRate;

    float m_CrouchMinRate;
    float m_CrouchMaxRate;
...
player_loco::player_loco(ObjectManager* pObjectManager, collision_mgr* collisionManager)
    ...
    , m_Move(*this)
{
    memset(&m_MPAnimIndex[0], -1, sizeof(m_MPAnimIndex));
...
loco::anim_type player_loco::GetMPReloadAnimType(inven_item InvenWeapon)
{
    ...
    switch (InvenWeapon) {
    default:
        assert(false); //ASSERTS( 0, "Weapon not supported in mp!" );
    case INVEN_NULL:
        return loco::ANIM_NULL;
    case INVEN_WEAPON_SMP:
        return loco::ANIM_RELOAD_SMP;
    case INVEN_WEAPON_SHOTGUN:
        return loco::ANIM_RELOAD_SHOTGUN;
    case INVEN_WEAPON_SNIPER_RIFLE:
        return loco::ANIM_RELOAD_SNIPER;
    case INVEN_WEAPON_DESERT_EAGLE:
        return loco::ANIM_RELOAD_DESERT_EAGLE;
    case INVEN_WEAPON_MESON_CANNON:
        return loco::ANIM_RELOAD_MSN;
    case INVEN_WEAPON_BBG:
        return loco::ANIM_RELOAD_BBG;
    case INVEN_WEAPON_DUAL_SMP:
        return loco::ANIM_RELOAD_DUAL_SMP;
    case INVEN_WEAPON_DUAL_SHT:
        return loco::ANIM_RELOAD_DUAL_SHT;
    case INVEN_WEAPON_MUTATION:
        return loco::ANIM_RELOAD;
    }
}
...
const char* player_loco::GetMPReloadAnimName(inven_item InvenWeapon)
{
    ...
    default:
    case INVEN_NULL:
        return "PST_EGL_RELOAD";
    case INVEN_WEAPON_SMP:
        return "RFL_SMP_RELOAD";
    case INVEN_WEAPON_SHOTGUN:
        return "RFL_SHT_RELOAD";
    case INVEN_WEAPON_SNIPER_RIFLE:
        return "RFL_SNI_RELOAD";
    case INVEN_WEAPON_DESERT_EAGLE:
        return "PST_EGL_RELOAD";
    case INVEN_WEAPON_MESON_CANNON:
        return "PST_EGL_RELOAD"; // *Not needed so just use eagle*
    case INVEN_WEAPON_BBG:
        return "PST_EGL_RELOAD"; // *Not needed so just use eagle*
    case INVEN_WEAPON_DUAL_SMP:
        return "PST_EGL_RELOAD"; // *Not needed so just use eagle*
...
loco::anim_type player_loco::GetMPShootPrimaryAnimType(inven_item InvenWeapon)
{
    ...
    case INVEN_NULL:
        return loco::ANIM_NULL;
    case INVEN_WEAPON_SMP:
        return loco::ANIM_SHOOT_SMP;
    case INVEN_WEAPON_SHOTGUN:
        return loco::ANIM_SHOOT_SHOTGUN;
    case INVEN_WEAPON_SNIPER_RIFLE:
        return loco::ANIM_SHOOT_SNIPER;
    case INVEN_WEAPON_DESERT_EAGLE:
        return loco::ANIM_SHOOT_DESERT_EAGLE;
    case INVEN_WEAPON_MESON_CANNON:
        return loco::ANIM_SHOOT_MSN;
    case INVEN_WEAPON_BBG:
        return loco::ANIM_SHOOT_BBG;
    case INVEN_WEAPON_DUAL_SMP:
        return loco::ANIM_SHOOT_DUAL_SMP;
    case INVEN_WEAPON_DUAL_SHT:
        return loco::ANIM_SHOOT_DUAL_SHT;
    case INVEN_WEAPON_MUTATION:
        return loco::ANIM_SHOOT_MUTANT;
    }
}
...
const char* player_loco::GetMPShootPrimaryAnimName(inven_item InvenWeapon)
{
    ...
    default:
        assert(false); //ASSERTS( 0, "Weapon not supported in mp!" );
    case INVEN_NULL:
        return "PST_EGL_SHOOT";
    case INVEN_WEAPON_SMP:
        return "RFL_SMP_SHOOT";
    case INVEN_WEAPON_SHOTGUN:
        return "RFL_SHT_SHOOT";
    case INVEN_WEAPON_SNIPER_RIFLE:
        return "RFL_SNI_SHOOT";
    case INVEN_WEAPON_DESERT_EAGLE:
        return "PST_EGL_SHOOT";
    case INVEN_WEAPON_MESON_CANNON:
        return "MSN_SHOOT";
    case INVEN_WEAPON_BBG:
        return "RFL_BBG_SHOOT";
    case INVEN_WEAPON_DUAL_SMP:
        return "DUL_2MP_SHOOT";
    case INVEN_WEAPON_DUAL_SHT:
        return "DUL_2SH_SHOOT";
    case INVEN_WEAPON_MUTATION:
        return "MUT_SHOOT";
    }
}
...
loco::anim_type player_loco::GetMPShootSecondaryAnimType(inven_item InvenWeapon)
{
    ...
    case INVEN_NULL:
        return loco::ANIM_NULL;
    case INVEN_WEAPON_SMP:
        return loco::ANIM_SHOOT_SECONDARY_SMP;
    case INVEN_WEAPON_SHOTGUN:
        return loco::ANIM_SHOOT_SECONDARY_SHOTGUN;
    case INVEN_WEAPON_SNIPER_RIFLE:
        return loco::ANIM_SHOOT_SECONDARY_SNIPER;
    case INVEN_WEAPON_DESERT_EAGLE:
        return loco::ANIM_SHOOT_SECONDARY_DESERT_EAGLE;
    case INVEN_WEAPON_MESON_CANNON:
        return loco::ANIM_SHOOT_SECONDARY_MSN;
    case INVEN_WEAPON_BBG:
        return loco::ANIM_SHOOT_BBG;
    case INVEN_WEAPON_DUAL_SMP:
        return loco::ANIM_SHOOT_DUAL_SMP;
    case INVEN_WEAPON_DUAL_SHT:
        return loco::ANIM_SHOOT_DUAL_SHT_SECONDARY;
    case INVEN_WEAPON_MUTATION:
        return loco::ANIM_SHOOT_SECONDARY_MUTANT;
    }
}
...
const char* player_loco::GetMPWeaponName(player_loco::mp_weapon MPWeapon)
{
    ...
    switch (MPWeapon) {
    default:
        assert(false); //ASSERTS( 0, "You need to add new mp weapon type here!" );
    case MP_WEAPON_RFL:
        return "RFL"; // Covers smp: sniper: shotgun, bbg
    case MP_WEAPON_PST:
        return "PST"; // Covers eagle
    case MP_WEAPON_MSN:
        return "MSN"; // Covers mason cannon
    case MP_WEAPON_DUAL:
        return "DUL"; // Covers dual smp: dual eagle, dual sht
    case MP_WEAPON_MUT:
        return "MUT"; // Covers mutant
    }
}
...
const char* player_loco::GetMPAnimName(player_loco::mp_anim MPAnim)
{
    switch (MPAnim) {
    default:
        assert(false); //ASSERTS( 0, "You need to add new mp anim type here!" );
    case MP_ANIM_WALK_IDLE:
        return "RUN_IDLE";
    case MP_ANIM_WALK_IDLE_TURN_LEFT:
        return "RUN_IDLE_TURN_LEFT";
    case MP_ANIM_WALK_IDLE_TURN_RIGHT:
        return "RUN_IDLE_TURN_RIGHT";
    ...
    case MP_ANIM_WALK_MOVE_FRONT:
        return "RUN_MOVE_FRONT";
    case MP_ANIM_WALK_MOVE_LEFT:
        return "RUN_MOVE_LEFT";
    case MP_ANIM_WALK_MOVE_BACK:
        return "RUN_MOVE_BACK";
    case MP_ANIM_WALK_MOVE_RIGHT:
        return "RUN_MOVE_RIGHT";

    case MP_ANIM_RUN_IDLE:
        return "RUN_IDLE";
    case MP_ANIM_RUN_IDLE_TURN_LEFT:
        return "RUN_IDLE_TURN_LEFT";
    case MP_ANIM_RUN_IDLE_TURN_RIGHT:
        return "RUN_IDLE_TURN_RIGHT";
    case MP_ANIM_RUN_MOVE_FRONT:
        return "RUN_MOVE_FRONT";
    case MP_ANIM_RUN_MOVE_LEFT:
        return "RUN_MOVE_LEFT";
    case MP_ANIM_RUN_MOVE_BACK:
        return "RUN_MOVE_BACK";
    case MP_ANIM_RUN_MOVE_RIGHT:
        return "RUN_MOVE_RIGHT";

    case MP_ANIM_CROUCH_IDLE:
        return "CROUCH_IDLE";
    case MP_ANIM_CROUCH_IDLE_TURN_LEFT:
        return "CROUCH_IDLE_TURN_LEFT";
    case MP_ANIM_CROUCH_IDLE_TURN_RIGHT:
        return "CROUCH_IDLE_TURN_RIGHT";
    case MP_ANIM_CROUCH_MOVE_FRONT:
        return "CROUCH_MOVE_FRONT";
    case MP_ANIM_CROUCH_MOVE_LEFT:
        return "CROUCH_MOVE_LEFT";
    case MP_ANIM_CROUCH_MOVE_BACK:
        return "CROUCH_MOVE_BACK";
    case MP_ANIM_CROUCH_MOVE_RIGHT:
        return "CROUCH_MOVE_RIGHT";

    case MP_ANIM_JUMP:
        return "JUMP";
    case MP_ANIM_GRENADE:
        return "GRENADE";
    case MP_ANIM_MELEE:
        return "MELEE";

    case MP_ANIM_STAND_LEAN_LEFT:
        return "LEAN_LEFT_IN";
    case MP_ANIM_STAND_LEAN_RIGHT:
        return "LEAN_RIGHT_IN";
    case MP_ANIM_CROUCH_LEAN_LEFT:
        return "CROUCH_LEAN_LEFT_IN";
    case MP_ANIM_CROUCH_LEAN_RIGHT:
        return "CROUCH_LEAN_RIGHT_IN";
    }
}

//==============================================================================

void player_loco::InitAnimIndices()
{
    ...
    for (int iWeapon = 0; iWeapon < MP_WEAPON_COUNT; iWeapon++) {
        // Loop over all anims
        const char* pWeapon = GetMPWeaponName((mp_weapon)iWeapon);
        for (int iAnim = 0; iAnim < MP_ANIM_COUNT; iAnim++) {
            ...
            int         AnimIndex = pAnimGroup->GetAnimIndex(xfs("%s_%s", pWeapon, pAnim));

            // Must be present for ghosts!
            if (m_bGhostMode) {
                assert(AnimIndex != -1); //, xfs(" %s is missing %s_%s see Aaron", m_hAnimGroup.GetName(), pWeapon, pAnim ) );
            }
    ...
    for (uint32_t iShoot = 0; iShoot < (sizeof(MPWeapons) / sizeof(MPWeapons[0])); iShoot++) {
        ...
        int         ReloadAnimIndex = pAnimGroup->GetAnimIndex(pReloadAnimName);
        ...
        int         PrimaryAnimIndex = pAnimGroup->GetAnimIndex(pPrimaryAnimName);
        ...
        int         SecondaryAnimIndex = pAnimGroup->GetAnimIndex(pSecondaryAnimName);
...
struct constraint_info
{
    ...
    float       m_MassRatio0; // Mass translation ratio0
    float       m_MassRatio1; // Mass translation ratio0
    float       m_Inertia0;   // Rotation ratio0
    float       m_Inertia1;   // Rotation ratio1
    const char* m_pConBone0;  // Constraint point0
    const char* m_pConBone1;  // Constraint point1
    float       m_MinDist;    // Min dist to keep points
    float       m_MaxDist;    // Max dist to keep points
};

//==============================================================================

static Matrix4 ComputeBoneL2W(const AnimGroup*                   pAnimGroup,
                              const AnimInfo&                    AnimInfo,
                              int                                 iBone,
                              const loco_ik_solver::bone_mapping* pMappings = nullptr,
                              int                                 nMappings = 0)
{
    // Clear
    Matrix4 L2W;
...
static void SetupMapping(const AnimGroup*             pAnimGroup,
                         const mapping_info&           Info,
                         loco_ik_solver::bone_mapping& Mapping)
{
    // Lookup bone/rigid body indices
    int iBone = pAnimGroup->GetBoneIndex(Info.m_pBone, true);
    assert(iBone != -1);
...
static void SetupConstraint(const AnimGroup*                    pAnimGroup,
                            const AnimInfo&                     animInfo,
...
{
    // Lookup bone indices
    int iBone0 = pAnimGroup->GetBoneIndex(Info.m_pBone0, true);
    int iBone1 = pAnimGroup->GetBoneIndex(Info.m_pBone1, true);
    int iConBone0 = pAnimGroup->GetBoneIndex(Info.m_pConBone0, true);
    int iConBone1 = pAnimGroup->GetBoneIndex(Info.m_pConBone1, true);
    assert(iBone0 != -1);
    assert(iBone1 != -1);
    assert(iConBone0 != -1);
...
// List of constraints
static constraint_info s_ConInfo[] =
    {
...
void player_loco::InitIK()
{
    ...
    // Lookup idle anim
    int iIdleAnim = GetAnimIndex(loco::ANIM_WALK_IDLE);
    if (iIdleAnim == -1) {
        return;
    }

    // Look up anim info
    const AnimInfo& IdleAnimInfo = pAnimGroup->GetAnimInfo(iIdleAnim);
...
bool player_loco::SetWeapon(inven_item InvenWeapon)
{
    ...
    if (InvenWeapon == INVEN_WEAPON_MUTATION) {
        ...
        actor* pActor = (actor*)objectManager->GetObjectByGuid(ActorGuid);
    ...
    int16_t* LocoAnims = &m_AnimLookupTable.m_Index[0];
    int16_t* WeaponAnims = &m_MPAnimIndex[Weapon * MP_ANIM_COUNT];
    ...
    float                   Frame = Cont.GetFrameParametric();
    ...
    // Setup aimer masks
    if ((m_CurrentWeaponAnims == INVEN_WEAPON_DUAL_SMP) || (m_CurrentWeaponAnims == INVEN_WEAPON_DUAL_SHT)) {
...
void player_loco::UpdateAnims(float DeltaTime,
                              bool  bIsAirborn,
                              bool  bIsCrouching,
                              float Lean)
{
    ...
    float          Speed = DeltaPos.x * DeltaPos.x + DeltaPos.z * DeltaPos.z;
    if (Speed > 0.0001f) {
        Speed = sqrt(Speed);
    }
    ...
    if (bIsAirborn) {
        ...
        int iJumpAnim = GetAnimIndex(loco::ANIM_JUMP);
    ...
    // Leaning and not moving?
        ...
        if (AnimType != ANIM_NULL) {
            ...
            if (Cont.GetAnimTypeIndex() == iAnim) {
                Cont.SetRate(0.0f);
                Cont.SetFrameParametric(abs(Lean));
            }
        }
    } else {
    ...
    if ((m_CurrentWeaponAnims == INVEN_WEAPON_DUAL_SMP) || (m_CurrentWeaponAnims == INVEN_WEAPON_DUAL_SHT) || (m_CurrentWeaponAnims == INVEN_WEAPON_MUTATION)) {
        bIK = false;
    }

    // Update aimer weight
    float AimerWeight = m_AimController.GetWeight();
    if (bAimer) {
        // Blend in
        AimerWeight = std::min(AimerWeight + (4.0f * DeltaTime), 1.0f);
    } else {
        // Blend out
        AimerWeight = std::max(AimerWeight - (4.0f * DeltaTime), 0.0f);
    }

    // Update IK weight
    float IKWeight = m_IKSolver.GetWeight();
    if (bIK) {
        // Blend in
        IKWeight = std::min(IKWeight + (4.0f * DeltaTime), 1.0f);
    } else {
        // Blend out
        IKWeight = std::max(IKWeight - (4.0f * DeltaTime), 0.0f);
    }
