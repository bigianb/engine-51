...
public:
    loco_anim_controller(ResourceManager* rm);
...
inline void loco_anim_controller::SetAccumYawMotion(bool bEnable)
{
...
inline bool loco_anim_controller::GetAccumYawMotion() const
{
...
inline void loco_anim_controller::SetAccumHorizMotion(bool bEnable)
{
...
inline bool loco_anim_controller::GetAccumHorizMotion() const
{
...
inline void loco_anim_controller::SetAccumVertMotion(bool bEnable)
{
...
inline bool loco_anim_controller::GetAccumVertMotion() const
{
...
inline void loco_anim_controller::SetRemoveYawMotion(bool bEnable)
{
...
inline bool loco_anim_controller::GetRemoveYawMotion() const
{
...
inline void loco_anim_controller::SetRemoveHorizMotion(bool bEnable)
{
...
inline bool loco_anim_controller::GetRemoveHorizMotion() const
{
...
inline void loco_anim_controller::SetRemoveVertMotion(bool bEnable)
{
...
inline bool loco_anim_controller::GetRemoveVertMotion() const
{
...
inline void loco_anim_controller::SetGravity(bool bEnable)
{
    m_bGravity = bEnable;
}
...
inline bool loco_anim_controller::GetGravity() const
{
    return m_bGravity;
}
...
inline void loco_anim_controller::SetWorldCollision(bool bEnable)
{
...
inline bool loco_anim_controller::GetWorldCollision() const
{
...
inline int loco_anim_controller::GetAnimIndex() const
{
    return m_iAnim;
}
...
inline int loco_anim_controller::GetAnimTypeIndex() const
{
    return m_iAnimType;
}
...
inline uint32_t loco_anim_controller::GetAnimFlags() const
{
    return m_AnimFlags;
}
...
inline int loco_anim_controller::GetNFrames() const
{
    return m_nFrames;
}
...
inline const AnimInfo& loco_anim_controller::GetAnimInfo() const
{
    assert(m_iAnim != -1);
...
inline float loco_anim_controller::GetPrevFrame() const
{
    return m_PrevFrame;
}
...
inline float loco_anim_controller::GetFrame() const
{
    return m_Frame;
}
...
inline int loco_anim_controller::GetPrevCycle() const
{
    return m_PrevCycle;
}
...
inline int loco_anim_controller::GetCycle() const
{
    return m_Cycle;
}
...
inline void loco_anim_controller::SetCycle(int Cycle)
{
    m_Cycle = Cycle;
}
...
inline void loco_anim_controller::SetRate(float Rate)
{
    assert(m_Rate >= 0);
    m_Rate = Rate;
}
...
inline float loco_anim_controller::GetRate() const
{
    assert(m_Rate >= 0);
    return m_Rate;
}
...
inline const BBox& loco_anim_controller::GetBBox() const
{
...
inline void loco_anim_controller::SetLooping(bool bLooping)
{
    m_bLooping = bLooping;
}
...
inline const anim_event& loco_anim_controller::GetEvent(int iEvent)
{
...
inline bool loco_anim_controller::IsEventActive(int iEvent)
{
...
inline bool loco_anim_controller::IsEventTypeActive(int Type)
{
...
inline float loco_anim_controller::GetWeight()
{
    return m_Weight;
}
