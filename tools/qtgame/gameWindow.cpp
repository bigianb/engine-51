...
GameWindow::GameWindow(QRhi::Implementation graphicsApi)
...
//! [ensure-texture]
void GameWindow::ensureFullscreenTexture(const QSize &pixelSize, QRhiResourceUpdateBatch *u)
{
